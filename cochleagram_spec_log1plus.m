function [X_ft, t, params] = cochleagram_log1plus(x, fs, dt, type, varargin)
% function [X_ft, t, params] = cochleagram_log1plus(x, fs, dt, type, varargin)
%
...
% type -- 'log' or 'cat-erb'
% varargin -- additional parameters: f_min, f_max, n_f
%
% output:
...
for tt = 1:size(spec,2)
    X(:,tt)=params.melbank.x*abs(spec(params.melbank.na:params.melbank.nb,tt));
end
