function [y,CenterFreqs, gains, earQ]=LyonPassiveEar_original(x,sr,df,numChannels,...
    stepfactor,differ,agcf,taufactor)
...
if df < 1; df = 1; end
if nargin < 5; stepfactor = 0.5; end
...
CenterFreqs = 0;
earQ = 2;
while length(CenterFreqs)<=1.5*numChannels
    [earFilters,CenterFreqs, gains] = DesignLyonFilters_original(sr, earQ, stepfactor);
    earQ = earQ * 2;
end
