function [y,CenterFreqs, gains]=LyonPassiveEar_old(x,sr,df,earQ,stepfactor, freqs, differ,agcf,taufactor)
...
if nargin < 7; differ=1; end
if nargin < 8; agcf=1; end
if nargin < 9; taufactor=3; end

[earFilters,CenterFreqs, gains] = DesignLyonFilters(sr, earQ, stepfactor,freqs);
